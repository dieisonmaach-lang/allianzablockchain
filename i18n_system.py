...
TRANSLATIONS = {
    ...
    'en': {
        ...
        'instructions': 'Instructions:',
        'copy_address_above': 'Copy the address above',
        'use_faucet_get_tokens': 'Use the faucet to get tokens',
        'keep_private_key_safe': 'Keep the private key safe (test only)',
        'never_share_private_key': 'NEVER share your private key',

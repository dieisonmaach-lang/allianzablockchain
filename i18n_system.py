...
TRANSLATIONS = {
    'pt': {
        ...
        'cross_chain_test': 'Teste Cross-Chain',
        'cross_chain_test_title': 'Teste de Transferência Cross-Chain',
        'cross_chain_test_subtitle': 'Teste transferências cross-chain com UChainID e ZK Proofs',
        'cross_chain_test_note': 'Esta é uma interface de teste para transferências cross-chain. Para o guia completo de interoperabilidade, veja Interoperabilidade.',
        'test_uchainid_zk': 'Testar UChainID & ZK',
        'copy': 'Copiar',
        'copied': 'Copiado!',
        'back_to_dashboard': 'Voltar ao Dashboard',
        'interoperability_guide': 'Guia de Interoperabilidade',
        'result': 'Resultado',
        '5_layers': '5 Camadas',
        'tests': 'Testes',
        'public': 'Públicos',
    ...
    'en': {
        ...
        'generating_wallet': 'Generating wallet...',
        ...
        # Developer Hub - SDK Available
        'sdk_available_npm': 'SDK Available on npm',
        'package_available_npm': 'The allianza-qss-js@1.0.0 package is available on npm! Install now and start using quantum security in your projects.',
        'install_now_start_using': 'Install now and start using quantum security in your projects.',
        # Developer Hub - Use Cases
        'use_cases': 'Use Cases',
        'prove_polygon_validated_anchor_bitcoin': 'Prove that a Polygon transaction was validated and anchor it on Bitcoin.',
        'generate_quantum_proofs_withdrawals': 'Generate quantum proofs for withdrawals and verify before processing.',
        'protect_smart_contract_interactions': 'Protect smart contract interactions with quantum proofs.',
        'certify_important_transactions': 'Certify important transactions with verifiable proofs.',
        # Developer Hub - Resources
        'resources': 'Resources',
        'test_qss_browser': 'Test QSS directly in the browser',
        'check_api_status_realtime': 'Check API status in real-time',
        'available': 'AVAILABLE',
        'install_now_npm': 'Install now: npm install allianza-qss-js',
        'public': 'PUBLIC',
        'source_code_examples_docs': 'Source code, examples and documentation',
        # Interoperability
        'how_it_works': 'How it works:',
        'choose_origin_blockchain': 'Choose the origin blockchain (e.g. Polygon)',
        'choose_destination_blockchain': 'Choose the destination blockchain (e.g. Bitcoin)',
        'enter_quantity_token': 'Enter the quantity and token',
        'paste_recipient_address': 'Paste the recipient address',
        'click_execute_real_transfer': 'Click "Execute REAL Transfer"',
        'transfer_will_appear_explorers': 'The transfer will appear on explorers!',
        'important': 'Important:',
        'real_transfer_appear_explorers': 'This is a REAL transfer that will appear on explorers',
        'need_sufficient_balance': 'You need sufficient balance on the origin blockchain',
        'no_balance_use_faucet': 'No balance? Use the Faucet to get test tokens',
        # Faucet
        'wallet_generated_success': 'Wallet Generated Successfully!',
        'address': 'Address',
        'private_key_testnet_only': 'Private Key (TESTNET ONLY)',
        'attention_testnet': 'ATTENTION: This is a testnet. NEVER use this private key on mainnet!',
        ...
        'quantum_security': 'Quantum Security',
        'signed_with_pqc': 'Signed with PQC',
        'qrs3_verified': 'QRS-3 Verified',
        'supported_blockchains': 'Supported Blockchains',
        'recent_blocks': 'Recent Blocks',
        'information': 'Information',
        'blocks_being_created': 'Blocks are being created, but there are no pending transactions to include in them yet. This is normal - empty blocks are created periodically to keep the network active. When there are transactions, they will appear here automatically.',
        'transactions': 'transactions',
        'total': 'Total',
        'pqc_signed': 'PQC Signed',
        'size': 'Size',
        'copy_json': 'Copy JSON',
        'open_json': 'Open JSON',
        'recent_transactions': 'Recent Transactions',
        # QRS-3 Verifier
        'copy_message_above': 'Copy the message above',
        'copy_complete_json_signature': 'Copy the complete JSON signature',
        'paste_qrs3_verifier': 'Paste in QRS-3 Verifier',
        'click_verify_signature': 'Click \'Verify Signature\'',
        'should_show_valid': 'Should show ✅ Valid Signature!',
        'verification_details': 'Verification Details',
        'ecdsa_valid': 'ECDSA Valid',
        'ml_dsa_valid': 'ML-DSA Valid',
